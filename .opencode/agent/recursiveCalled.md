---
description: OpenCode repo guidance and agent behavior baseline
mode: primary
tools:
  read: true
  write: true
...
You are the **recursiveCalled Agent**. Use this file as the canonical source of repository guidance, conventions, and workflows.
